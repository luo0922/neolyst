...
The system SHALL allow SA and Admin to approve, reject, and reopen reports according to state machine.
...
#### Scenario: Reject submitted report
- **WHEN** SA or Admin rejects a report in `submitted` with reason
